 ...
 *
 */
public class FunctionCloudEventsHelper implements ApplicationContextAware {
	...
	boolean isCloudEvent(Map<String, Object> messageHeaders) {
		return CloudEventAttributeUtils.toAttributes(messageHeaders).isValidCloudEvent();
	}

	Message<?> postProcessInputMessage(Message<?> inputMessage, MessageConverter messageConverter) {
