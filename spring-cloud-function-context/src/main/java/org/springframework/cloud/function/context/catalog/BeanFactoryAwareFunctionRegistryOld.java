 ...
 * @since 3.0
 */
public class BeanFactoryAwareFunctionRegistryOld extends SimpleFunctionRegistryOld implements ApplicationContextAware, InitializingBean {

	private ConfigurableApplicationContext applicationContext;

	public BeanFactoryAwareFunctionRegistryOld(ConversionService conversionService,
